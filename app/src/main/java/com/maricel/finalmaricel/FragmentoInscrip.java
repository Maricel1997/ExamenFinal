...
public class FragmentoInscrip extends Fragment {
    Button botonEnvio;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragemento_inscripcion, container, false);
        ...
        botonEnvio= (Button) view.findViewById(R.id.btnEnvio);
